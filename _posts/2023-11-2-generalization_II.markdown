...
Since the average over all possible data sets of $\Sigma_{\rm tr}$ is $\left\langle\Sigma_{\rm tr}\right\rangle_X=I$, when we test how well this model generalizes, we will assume the population mean of the above loss, $\ell_\mathrm{gen}=\boldsymbol{D}^T\boldsymbol{D}/2$. For the time being, we care mainly about the steady state of the system, the dynamics will be studied with some more details towards the end of this post. For that reason, we will currently work in the gradient flow limit. 
...
$$
    \ell_\mathrm{gen}=\frac{1}{2}\sum_{i=1}^D(S_{i,0}-T_i)^2e^{-2\lambda_i t}.
$$
...
$$
    \lim_{t\to\infty}\left\langle\ell_\mathrm{gen}\right\rangle_{X}=\frac{1}{2}\left(1-\frac{N_{\rm tr}}{D}\right)\Vert \boldsymbol{S}_0-\boldsymbol{T}\Vert_2^2.
$$
...
<div id="eq_free_loss">
$$
    \lim_{t\to\infty}\left\langle\ell_\mathrm{gen}\right\rangle_{X,S_0}=\frac{1}{2}\left(1-\frac{N_{\rm tr}}{D}\right)\left(\left\langle\Vert \boldsymbol{S}_0\Vert_2^2\right\rangle_{S_0}+\Vert \boldsymbol{T}\Vert_2^2\right). \tag{1}
$$
</div>
...
$$
    \lim_{t\to\infty}\left\langle\ell_\mathrm{gen}\right\rangle=\frac{1}{2}\Vert \boldsymbol{T}\Vert_2^2\left\langle \frac{\lambda^2}{(\lambda+\lambda_i)^2} \right\rangle. \tag{2}
$$
</div>
...
$$
    \lim_{t\to\infty}\left\langle\ell_\mathrm{gen}\right\rangle_X=\frac{1}{2}\left(1-\frac{N_{\rm tr}}{D}\right)\Vert \boldsymbol{T}\Vert_2^2+{\cal O}(\lambda^2). \tag{3}
$$
</div>
