...
It will prove to be very convinient to study the Fourier Transform (FT) of $f_S$, (which in statisticians lingo is known as the *characteristic function*) 
...
The sample mean is defined as $\overline{X}=S/N$. It is a simple exrcise to get from $f_S(s)$ to
...
$H_X(t)=\log \varphi_X(t)$ is someties refeard to as the cumulant generating function. The usefulness of this function should be familiar to most physicsits, as it is very similar to the log of the partition function, both in the context  of thermodynamics and quantum field theories. The $n$'th taylor coefficient of $H$ gives the $n$'th cumulant
...
From the prevoius discussion, it is clear that the mean and varince of $\overline{X}$ are given by

$$  \left\langle \overline{X} \right\rangle=\left\langle {X} \right\rangle=\mu \;\;,\;\;{\rm Var}[\overline{X}]=\frac{1}{N}{\rm Var}[X]=\frac{\sigma^2}{N}
$$

We, therefore, can define a normalized variable with unit variance and vanishing mean

$$
Z=\frac{\overline{X}-\mu}{\sigma/\sqrt{N}}
$$

Using again FT properties, it is simple to see that
...
This allows us to very simply write the cumulats of $Z$ in terms of the cumulats of $X$,
...
Exponintiating, we get a Gaussian, whose inverse FT is the PDF of $Z$

$$ f_Z(z)= \frac{1}{\sqrt{2\pi}}e^{-z^2/2}. $$

We have estabilished the CLT!
