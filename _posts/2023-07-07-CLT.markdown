...
---
I'm freshening up my statistics knowledge, and trying to make a better sense of the [Central Limit Theorem (CLT)](https://en.wikipedia.org/wiki/Central_limit_theorem). There are quite a few derivations out there, and there is a great in depth post about it by Terence Tao [here](https://terrytao.wordpress.com/2010/01/05/254a-notes-2-the-central-limit-theorem/).
...
We, therefore, can define a normalized variable with unit variance and zero mean
