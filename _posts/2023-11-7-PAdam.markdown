...
2. [Proximal Gradient Descent with $\Lambda_p$ Regularization and its Adiabatic Limit.](#a-simple-proximal-gradient-for-any--norm)
3. [The `PAdam` Algorithm: A 0-th Order PyTorch Implementation and Experiments on FashionMNIST](#padam-the-adam-optimizer).
4. [Future Directions and Open Questions.](#future-directions-and-open-questions)

A reader less interested in the mathematical details of the algorithm, and more interested in the practical implementation and performance, can skip directly to section 3. 
